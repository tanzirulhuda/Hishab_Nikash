  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Employee Ledger</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="../index.php">Home</a></li>
              <li class="breadcrumb-item">Employee Ledger</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-lg-12">
            <div class="card p-3">
                <div class="text-left">
                    <p style="margin-bottom: 1px;"><strong>Employee Name: </strong>Kalam</p>
                    <p style="margin-bottom: 1px;">Address : Khulna</p>
            ...
            <div class="card">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <table id="employee-ledger" class="table table-bordered table-striped">
                    ...
                    <tr>
                        ...
                        <td class="text-right text-danger">11,500</td>
                    </tr>
                    <tr>
                        <td>1</td>
                        <td>01/10/2021</td>
                    ...
                    <tr class="bg-gradient-info">
                        ...
                        <td class="text-right" colspan="3">16,500.00</td>
                    </tr>
                    </tbody>
                    </table>
                </div>
