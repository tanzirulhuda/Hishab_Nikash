<?php
 ...
 $mainPage = 'hr-management';
 $subPage = 'employee-list';
?>
          ...
          <div class="card">
              <div class="card-header bg-gradient-primary">
                ...
                <div class="d-flex justify-content-end">
                    <a href="./add_employee.php" class="btn btn-small btn-default"><i class="fas fa-plus-circle"></i></a>
                </div>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="employee-list" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>017#######</td>
                    <td>31/10/2021</td>
                    <td class="text-center"><img style="width: 2.5rem; height: auto;" class="elevation-1" src="../images/employee_images/employee.jpg" alt=""></td>
