        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item">Medicine list</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="card">
              <div class="card-header bg-gradient-primary">
                ...
                <div class="d-flex justify-content-end">
                    <a href="./add-medicines.php" class="btn btn-small btn-default"><i class="fas fa-plus-circle"></i></a>
                </div>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="medicine-list" class="table table-bordered table-striped">
                  ...
                  <tr>
                    <td>1</td>
                    <td>31/10/2021</td>
                    <td>Square Pharmaceuticals Ltd.</td>
                    <td>16348773921	</td>
                    <td>1200</td>
                    <td>800</td>
                    <td>400</td>
